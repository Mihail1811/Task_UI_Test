...
class CustomersPage(BasePage):
    def __init__(self, driver):
        ...
        self.sort_by_name_btn = (
            By.XPATH, "//a[contains(text(), 'First Name')]"
            )
    ...
    @allure.step(r"Удаляем клиента с тем именем, "
                 r"у которого длина будет ближе к среднему арифметическому")
